/* ===================================================================
   ...
   cap-02.js — Lógica específica del Capítulo 2 (Saber 11)
   Generado en Paso 5 del refactor a partir de cap-template.js.

   Contenido:
   - Subnav de las 5 subsecciones
   - Tabs del dashboard embebido (1 página por ahora)
   - DASH_BASE_URL pendiente de pegar tras publicar el .pbix con
     tema ETITC aplicado
   =================================================================== */
...
(function(){
  ...
  if(!document.querySelector('.page[data-page="ch2"]')) return;

  // ----- Subnav dentro del Cap. 2 -----
  const subnavButtons = document.querySelectorAll('.page[data-page="ch2"] .subnav button');
  subnavButtons.forEach(btn => {
    btn.addEventListener('click', () => {
      ...
      document.querySelectorAll('.page[data-page="ch2"] .subsection').forEach(s => s.classList.remove('is-active'));
      const target = document.querySelector(`.page[data-page="ch2"] .subsection[data-sub="${sub}"]`);
  ...
  // Cuando publiques el .pbix con tema ETITC aplicado, pegá la URL acá:
  //   const DASH_BASE_URL = 'https://app.powerbi.com/view?r=...';
  const DASH_BASE_URL = 'https://app.powerbi.com/view?r=eyJrIjoiNDI0NzY5ZjktYmI0MC00OTdiLTkyNzYtZjNjMDQyNTVmN2EzIiwidCI6IjQ5NWZkMDQ2LWQ4NjQtNDY2Ny05ZWU4LTUwNjc5NzY0ZDgzNCIsImMiOjR9';
